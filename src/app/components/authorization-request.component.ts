      ...
      <div class="mt-6 pt-6 border-t flex-shrink-0">
        <div class="bg-gray-50 rounded-lg p-4 mb-4">
          <div class="flex justify-between items-center mb-2">
            ...
            <span class="font-semibold">$ {{ formatCurrency(getTotalEstimated()) }}</span>
          </div>
          <div class="flex justify-between items-center mb-2">
            <span class="text-green-700">Total autorizado:</span>
            <span class="font-bold text-green-700">$ {{ formatCurrency(getTotalAuthorized()) }}</span>
          </div>
          <div class="flex justify-between items-center">
            <span class="text-red-700">Total rechazado:</span>
            <span class="font-bold text-red-700">$ {{ formatCurrency(getTotalRejected()) }}</span>
          </div>
        </div>

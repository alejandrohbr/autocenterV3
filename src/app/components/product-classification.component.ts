      ...
      <div class="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div *ngIf="product" class="p-6 space-y-6">
          <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <p class="text-sm text-gray-700"><strong>Costo:</strong> \${{ formatCurrency(product.precio) }}</p>
          ...
          <div>
            ...
            <div class="bg-green-50 border border-green-200 rounded-lg p-4">
              <p class="text-2xl font-bold text-green-700">
                \${{ formatCurrency(classificationData.precioVenta) }}
              </p>
              <p class="text-xs text-gray-600 mt-1">
                Costo: \${{ formatCurrency(product.precio) }} + {{ classificationData.margen }}% = \${{ formatCurrency(classificationData.precioVenta) }}
              </p>
            </div>
          </div>
        </div>

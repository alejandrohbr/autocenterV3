          ...
          <div *ngIf="newPart.costo && newPart.costo > 0" class="mb-3 p-3 bg-blue-50 border border-blue-200 rounded-lg">
            <div class="grid grid-cols-4 gap-3 text-sm">
              <div>
                ...
                <p class="font-semibold text-gray-900">{{ formatCurrency(newPart.costo! * 1.16) }}</p>
              </div>
              <div>
                <p class="text-gray-600">Precio Venta:</p>
                <p class="font-semibold text-green-600">{{ formatCurrency(newPart.precio || 0) }}</p>
              </div>
              <div>
                <p class="text-gray-600">Margen:</p>
                <p class="font-semibold text-blue-600">{{ formatCurrency(newPart.margen || 0) }}</p>
              </div>
              <div>
                <p class="text-gray-600">% Margen:</p>
